...
public class YoutubeSub {
  ...
  public static void main(String[] args) {
    ...
    while(!userId.equals(UserAccount.userID) || !userPw.equals(UserAccount.userPW)){
     ...
     */
    SubtitleLogic subtitleLogic = new SubtitleLogic();
    System.out.println(subtitleLogic.inputSub());
